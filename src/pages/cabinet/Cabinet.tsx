...
function Cabinet() {
    ...
    const [logoutMutation, { isLoading: isLoadingLogout, isError: isErrorLogout }] = useLogoutMutation();
    const [changeUser, { isLoading: isLoadingChange, isSuccess: isSuccessChange, isError: isErrorChange, error }] = useChangeUserMutation();
    ...
    return (
        <div className=' d-flex flex-fill flex-column'>
            ...
            <div className="d-flex justify-content-between cabinet-buttons">
                <button onClick={() => logOutClick()} className='justify-self-end btn btn-danger d-flex align-items-center gap-2 mt-4'>
                ...
                <button onClick={() => deleteAccClick()} className='justify-self-end btn btn-danger d-flex align-items-center gap-2 mt-4'>
                    {variables.LANGUAGES[language].DELETE_ACCOUNT}
