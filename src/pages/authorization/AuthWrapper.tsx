            ...
            <div className="border rounded p-5 inner-window">
                <ul className="navbar-nav flex-row justify-content-between gap-3">
                    <li className="nav-item w-100">
                        <Link className="btn w-100 btn-outline-primary" to={'/login'}>{variables.LANGUAGES[language].LOGIN}</Link>
                    </li>
                    <li className="nav-item w-100">
                        <Link className="btn w-100 btn-outline-primary" to={'/register'}>{variables.LANGUAGES[language].REGISTER}</Link>
                    </li>
                </ul>
                {children}
            </div>
